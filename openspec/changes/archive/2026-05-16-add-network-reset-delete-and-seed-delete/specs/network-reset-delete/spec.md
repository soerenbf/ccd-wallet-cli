...
- **WHEN** the user runs `ccd-wallet network reset`
- **AND** interactive mode is enabled
- **AND** stored identities or accounts reference genesis hash `abc`
